...
We make a few more assumptions than POSIX:
...
=item * The nonstandard system header F<sys/cdefs.h> is required, though not
really I<used> for anything since we define C<__RCSID()> &c. away.
